    ...
    <QueryClientProvider client={queryClient}>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/frontdesk/dispense-logs" element={<P roles={['frontdesk']}><InventoryPage /></P>} />
          ...
          <Route path="/manager/transaction-history" element={<P roles={['manager']}><ReportsPage /></P>} />
          <Route path="/manager/patient-history" element={<P roles={['manager']}><PatientsPage /></P>} />
          <Route path="/manager/audit-log" element={<P roles={['manager']}><AuditPage /></P>} />
          ...
          <Route path="/admin/subscription" element={<P roles={['admin']}><SubscriptionsPage /></P>} />
