  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <Link to="/assistant/dispensing" className="p-6 bg-card rounded-xl border border-border hover:shadow-md transition-shadow">
        ...
        <Link to="/assistant/glasses-orders" className="p-6 bg-card rounded-xl border border-border hover:shadow-md transition-shadow">
        ...
        <Link to="/assistant/glasses-prescription" className="p-6 bg-card rounded-xl border border-border hover:shadow-md transition-shadow">
        ...
        <Link to="/assistant/outreach" className="p-6 bg-card rounded-xl border border-border hover:shadow-md transition-shadow">
        ...
        <Link to="/appointments" className="p-6 bg-card rounded-xl border border-border hover:shadow-md transition-shadow">
        ...
        <Link to="/patients" className="p-6 bg-card rounded-xl border border-border hover:shadow-md transition-shadow">
