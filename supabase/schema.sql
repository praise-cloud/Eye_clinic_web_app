...
-- PROFILES POLICIES
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'profiles' AND policyname = 'All view profiles') THEN
    CREATE POLICY "All view profiles" ON public.profiles FOR SELECT TO authenticated USING (TRUE);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'profiles' AND policyname = 'Admin manage profiles') THEN
    CREATE POLICY "Admin manage profiles" ON public.profiles FOR ALL TO authenticated USING (get_user_role() = 'admin');
  END IF;
END $$;

-- PATIENTS POLICIES
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'patients' AND policyname = 'All view patients') THEN
    CREATE POLICY "All view patients" ON public.patients FOR SELECT TO authenticated USING (TRUE);
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'patients' AND policyname = 'Frontdesk/admin manage patients') THEN
    CREATE POLICY "Frontdesk/admin manage patients" ON public.patients FOR ALL TO authenticated USING (get_user_role() IN ('frontdesk', 'admin'));
  END IF;
END $$;

-- APPOINTMENTS POLICIES
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'appointments' AND policyname = 'All view appointments') THEN
    CREATE POLICY "All view appointments" ON public.appointments FOR SELECT TO authenticated USING (TRUE);
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'appointments' AND policyname = 'Doctor manages own appointments') THEN
    CREATE POLICY "Doctor manages own appointments" ON public.appointments FOR ALL TO authenticated USING (doctor_id = auth.uid());
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'appointments' AND policyname = 'Frontdesk/admin manage appointments') THEN
    CREATE POLICY "Frontdesk/admin manage appointments" ON public.appointments FOR ALL TO authenticated USING (get_user_role() IN ('frontdesk', 'admin'));
  END IF;
END $$;

-- DRUGS POLICIES
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'drugs' AND policyname = 'All staff view drugs') THEN
    CREATE POLICY "All staff view drugs" ON public.drugs FOR SELECT TO authenticated USING (TRUE);
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'drugs' AND policyname = 'Frontdesk/admin manage drugs') THEN
    CREATE POLICY "Frontdesk/admin manage drugs" ON public.drugs FOR ALL TO authenticated USING (get_user_role() IN ('frontdesk', 'admin'));
  END IF;
END $$;

-- DRUG DISPENSING POLICIES
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'drug_dispensing' AND policyname = 'View dispensing') THEN
    CREATE POLICY "View dispensing" ON public.drug_dispensing FOR SELECT TO authenticated USING (get_user_role() IN ('doctor', 'frontdesk', 'admin'));
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'drug_dispensing' AND policyname = 'Frontdesk/admin dispenses') THEN
    CREATE POLICY "Frontdesk/admin dispenses" ON public.drug_dispensing FOR INSERT TO authenticated WITH CHECK (get_user_role() IN ('frontdesk', 'admin'));
  END IF;
END $$;

-- GLASSES INVENTORY POLICIES
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'glasses_inventory' AND policyname = 'All view glasses') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'glasses_orders' AND policyname = 'All view orders') THEN
    CREATE POLICY "All view orders" ON public.glasses_orders FOR SELECT TO authenticated USING (TRUE);
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'glasses_orders' AND policyname = 'Frontdesk/admin manage orders') THEN
    CREATE POLICY "Frontdesk/admin manage orders" ON public.glasses_orders FOR ALL TO authenticated USING (get_user_role() IN ('frontdesk', 'admin'));
  END IF;
END $$;

-- INVENTORY OTHERS POLICIES
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'inventory_others' AND policyname = 'All view inventory others') THEN
    CREATE POLICY "All view inventory others" ON public.inventory_others FOR SELECT TO authenticated USING (TRUE);
  END IF;
END $$;
...
-- PAYMENTS POLICIES
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'payments' AND policyname = 'Finance view payments') THEN
    CREATE POLICY "Finance view payments" ON public.payments FOR SELECT TO authenticated USING (get_user_role() IN ('frontdesk', 'admin', 'manager'));
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'payments' AND policyname = 'Frontdesk/admin insert payments') THEN
    CREATE POLICY "Frontdesk/admin insert payments" ON public.payments FOR INSERT TO authenticated WITH CHECK (get_user_role() IN ('frontdesk', 'admin', 'manager'));
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'payments' AND policyname = 'Admin manage payments') THEN
    CREATE POLICY "Admin manage payments" ON public.payments FOR ALL TO authenticated USING (get_user_role() = 'admin');
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'messages' AND policyname = 'Edit own messages') THEN
    CREATE POLICY "Edit own messages" ON public.messages FOR UPDATE TO authenticated USING (sender_id = auth.uid());
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'messages' AND policyname = 'Delete own messages') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'notifications' AND policyname = 'System creates notifications') THEN
...
-- AUDIT LOGS POLICIES
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'audit_logs' AND policyname = 'Admin and manager view audit') THEN
    CREATE POLICY "Admin and manager view audit" ON public.audit_logs FOR SELECT TO authenticated USING (get_user_role() IN ('admin', 'manager'));
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'audit_logs' AND policyname = 'Append audit') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'outreach_log' AND policyname = 'Frontdesk/admin outreach') THEN
    CREATE POLICY "Frontdesk/admin outreach" ON public.outreach_log FOR ALL TO authenticated USING (get_user_role() IN ('frontdesk', 'admin'));
  END IF;
END $$;

-- SETTINGS POLICIES
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'settings' AND policyname = 'Authenticated read settings') THEN
    CREATE POLICY "Authenticated read settings" ON public.settings FOR SELECT TO authenticated USING (TRUE);
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'settings' AND policyname = 'Admin manage settings') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'push_subscriptions' AND policyname = 'Own push sub') THEN
